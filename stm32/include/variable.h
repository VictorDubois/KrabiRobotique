...
//COMMAND
#define VITESSE_LINEAIRE_MAX 4.5
#define VITESSE_ANGULAIRE_MAX  0.01
#define ACCELERATION_LINEAIRE_MAX 0.05
#define ACCELERATION_ANGULAIRE_MAX (2*M_PI/5000.0) //(2*M_PI/5000.0)
...
//PIDFILTERANGLE
#define FILTER_ANGLE_KP 10 //0.1
#define FILTER_ANGLE_KD 0//35
#define FILTER_ANGLE_KI 0//0.1
#define FILTER_ANGLE_COEF 0.83

//PIDFILTERLINEAIRE
#define FILTER_LINEAIRE_KP 0.01 // 0.1
#define FILTER_LINEAIRE_KD 0.3//0.3
#define FILTER_LINEAIRE_KI 0.001//0.02
...
#define POS_DEPART_X 0
#define POS_DEPART_Y 0
