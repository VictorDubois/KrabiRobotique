...
//TRAPEZOIDALCOMMAND
#define DISTANCE_ARRET 15
#define ANGLE_ARRET 0.001
...
#define SEUIL_DETECTION 1500.//2000.
...
#define VITESSE_ANGULAIRE_MAX  0.0000001//0.005
#define ACCELERATION_LINEAIRE_MAX 1000000//0.05//0.1//0.05
#define ACCELERATION_ANGULAIRE_MAX (2*M_PI/20000.0) //(2*M_PI/5000.0)

//ODOMETRIE
#define TAILLE_ENTRAXE 265
#define RAYON_ROUE 40.326
#define NBR_TICK_PAR_TOUR 8192

//PIDFILTERANGLE
#define FILTER_ANGLE_KP 5 //0.1
#define FILTER_ANGLE_KI 0//0.1
#define FILTER_ANGLE_KD 0//35
#define FILTER_ANGLE_COEF 1//0.83

//PIDFILTERLINEAIRE
#define FILTER_LINEAIRE_KP 0.038//0.02 // 0.1
#define FILTER_LINEAIRE_KI 0.22//0.02//0.02
#define FILTER_LINEAIRE_KD 11.25//5//0.3//0.3
