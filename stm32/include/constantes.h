...
#define VITESSE_LINEAIRE_MAX 4.5//4.0/
#define VITESSE_ANGULAIRE_MAX 0.025//0.025
#define VITESSE_ANGULAIRE_SLOW_MAX 0.003//0.025
#define ACCELERATION_LINEAIRE_MAX 0.045//0.045
#define DECELERATION_LINEAIRE_MAX 0.035//0.08
#define ACCELERATION_ANGULAIRE_MAX 0.00025// 0.00035

// Odometrie

#define TAILLE_ENTRAXE 352.00//313.90//314.15
#define RAYON_ROUE 64.00/2.0
#define NBR_TICK_PAR_TOUR 8192

// PIDFILTERANGLE
// NE PAS TOUCHER !!!!
#define FILTER_ANGLE_KP 30.0
#define FILTER_ANGLE_KI 0.6
#define FILTER_ANGLE_KD 5
#define FILTER_ANGLE_COEF 1.0//0.89

// PIDFILTERLINEAIRE
// NE PAS TOUCHER !!!!
#define FILTER_LINEAIRE_KP 0.12//0.12
#define FILTER_LINEAIRE_KI 0.005//0.005
#define FILTER_LINEAIRE_KD 0.3//0.7
