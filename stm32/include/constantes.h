...
// Command
#ifndef ROBOTHW
#define VITESSE_LINEAIRE_MAX 10.0
#else
#define VITESSE_LINEAIRE_MAX 2.0
#endif
#define VITESSE_ANGULAIRE_MAX  0.006 //0.005
#define ACCELERATION_LINEAIRE_MAX  0.05//0.1//0.05
#define ACCELERATION_ANGULAIRE_MAX (2*M_PI/40000.0)//(2*M_PI/5000.0)//(2*M_PI/20000.0) //(2*M_PI/5000.0)
#define DECELERATION_LINEAIRE_MAX  0.05//0.1//0.05

// Odometrie
#define TAILLE_ENTRAXE 313.95
#define RAYON_ROUE  62.7/2.0 // 40.326
#define NBR_TICK_PAR_TOUR 4096

// PIDFILTERANGLE
#define FILTER_ANGLE_KP 0.75//3.6 //0.1
#define FILTER_ANGLE_KI 0.001//0.01//0.1
#define FILTER_ANGLE_KD 30//35 //30 //35//0.001//35
#define FILTER_ANGLE_COEF 0.77//0.83

// PIDFILTERLINEAIRE
#define FILTER_LINEAIRE_KP 0.0087//0.02 // 0.1
#define FILTER_LINEAIRE_KI 0.00042//0.21//0.22//0.02//0.02
#define FILTER_LINEAIRE_KD 0.1 //0.3//0.01//11.25//5//0.3//0.3
#define FILTER_LINEAIRE_COEF 0.77//0.83
