#ifndef COMMANDTOURNER_H
#define COMMANDTOURNER_H
...
class CommandTourner : public Command
{
    public:
        ...
        *  @param vitesseAngulaireFinale Vitesse angulaire avec laquel on souhaite que le robot termine sont ordre*/
        CommandTourner(Angle angle, VitesseAngulaire vitesseAngulaireFinale);
        /**@brief Destructeur de la classe */
        virtual ~CommandTourner();
